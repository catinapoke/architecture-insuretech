...
```
query($clientId: ID!) {
  # Получение разных данных клиента
  client(id: $clientId) {
    id
    name
    documents {
...
query($clientId: ID!) {
  # Получение имени клиента, аналог /clients/{id}
  client(id: $clientId) {
    id
    name
  }
...
query($clientId: ID!) {
  # Получение документов клиента, аналог /clients/{id}/documents
  client(id: $clientId) {
    documents {
      id
      type
...
query($clientId: ID!) {
  # Получение родственников клиента, аналог /clients/{id}/relatives
  client(id: $clientId) {
    relatives {
      id
      name
