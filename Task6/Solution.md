...
Записал конфигурацию в `nginx.conf`. Установлен лимит на 10 запросов/минуту и 429 статус ответа.
Добавил burst и nodelay, чтобы было не 1 запрос/6 секунд, а именно 10 запросов с лимитом в минуту.